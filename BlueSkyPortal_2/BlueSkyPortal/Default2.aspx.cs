            ...
            switch (homeElementsGrpTbl[0].title)
            {
                ...
                case "Booking 2":
                    ...
                    if (dv[i]["defaultPicAddr"] != null)
                        booking2Str += "<img src='" + dv[i]["defaultPicAddr"] + "' alt='" + dv[i]["title"] + "' style='width: 60%;'>";
                    booking2Str += "</div>";
                ...
                case "Testimonials":
                    ...
                    for (int z = 0; z < testimonialTbl.Count; z++)
                    {
                        if (counterPlus == 1)
                        {
                            testimonialStr += "<div class='media-container-row'>" +
                                ...
                                "<div class='media-content px-5 align-self-center mbr-white py-2'>" +
                                              ...
                                              "<p class='mbr-author-desc mbr-fonts-style display-7'>" + testimonialTbl[z].guestSigniture + "</p></div>" +

                                              "<div class='mbr-figure pr-lg-5'>" +
                            ...
                            testimonialStr += "<div class='media-content px-5 align-self-center mbr-white py-2'><div class='avatar-placeholder'>" +
                                              "<div class='centerize card-block'><div class='avatar'><img src='" + companyDetTbl[0].managerPic + "' alt='' /></div></div>" +
                                              "<div class='color-dark content-avatar'><p>" + testimonialTbl[z].adminReply + "</p><div class='intro-avatar'>" +
                        ...
                        {
                            testimonialStr += "<div class='mb-5 media-container-row'><div class='mbr-figure pl-lg-5' style='width: 75%;'>" +
                                                                      "<img src='" + testimonialTbl[z].guestPic + "' alt='" + testimonialTbl[z].title + "'>" +
                ...
                case "Our Partner":
                    ...
                    sectionsAddedStr += homeElementsGrpTbl[0].openTag;
                    sectionsAddedStr += "<div class='container'><div class='row'><div class='col-12' style='text-align: center;'><h2 class='mbr-section-title pb-3 mbr-fonts-style display-2'>" + dv[i]["title"] + "</h2><h3 class='mbr-section-subtitle mbr-light mbr-fonts-style display-5'>" + dv[i]["detail"] + "</h3></div></div></div>";
