                    ...
                    <div class="en-style  row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group row">
                                <label for="ddlSex" class="col-sm-1 col-form-label">Title</label>
                                <div class="col-sm-1">
                                ...
                                <label for="txtName" class="col-sm-1 col-form-label">Name</label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtName" runat="server" class="input-value form-control" placeholder="Name" AutoCompleteType="None"></asp:TextBox>
                                </div>

                                <label for="txtFamily" class="col-sm-1 col-form-label">Family</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <p id="lblError" runat="server" class="error-msg mfp-s-error" visible="false" nbforecolor="#FF3300">Please enter required Values...</p>
                                </div>
                            </div>
