<%@ Page Title="" Language="C#" MasterPageFile="~/footer.master" AutoEventWireup="true" CodeFile="information.aspx.cs" Inherits="news" %>
    ...
    <section class="top-title-others section lb p120">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message page-title text-center">
                            <h3 id="titleBigHtml" runat="server">Information</h3>
                            <ul class="breadcrumb">
                                <li><a href="default.aspx">Home</a></li>
                                <li id="titleSmallHtml" runat="server" class="active">Information</li>
                            </ul>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
        ...
        <section class="section gb nopadtop">
            <div class="container">
                <div class="boxed">
                    <div class="row">
                        <div id="infoHtml" runat="server" class="col-md-8">
                        ...
                        <div class="sidebar col-md-4">
                            <div class="widget clearfix">
                                ...
                                <div id="recentPostHtml" runat="server"  class="post-widget">
