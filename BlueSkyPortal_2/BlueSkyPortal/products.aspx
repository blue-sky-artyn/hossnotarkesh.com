<%@ Page Title="" Language="C#" MasterPageFile="~/footer.master" AutoEventWireup="true" CodeFile="products.aspx.cs" Inherits="product_category" %>
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-8 mb-md--50">
                            <div class="shop-products list">
                                <div id="productsHtml" runat="server" class="row">
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <aside class="shop-sidebar">
                                <div class="shop-widget mb--40">
                                    ...
                                    <ul id="productGrpHtml" runat="server" class="widget-list category-list">
                                        <li>
                                            <a href="shop.html">
