<%@ Page Title="" Language="C#" MasterPageFile="~/footer.master" AutoEventWireup="true" CodeFile="booking - tmp.aspx.cs" Inherits="booking" %>
                                    ...
                                    <div class="form-row">
                                     ...
                                     <div class="form-row">
                                        <div class="form__group col-12">
                                            ...
                                            <asp:Button ID="btnAppo" runat="server" CssClass="btn btn-fullwidth btn-bg-red btn-color-white btn-hover-2" Text="Book the Appointment"  />
                                        </div>
                                         </div>
