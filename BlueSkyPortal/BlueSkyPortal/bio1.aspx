<%@ Page Title="" Language="C#" MasterPageFile="~/footer.master" AutoEventWireup="true" CodeFile="bio1.aspx.cs" Inherits="about" %>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center flex-sm-row flex-column">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="current"><span>BIO</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="single-post">
                                ...
                                <article class="single-post-details">
                                    <div class="entry-header">
                                        <h2 id="companyNameHtml" runat="server" class="entry-title">Company Title</h2>
                                        <div class="entry-meta mb--30">
                                            <a id="companyDet1" runat="server" class="posted-on">September 15, 2018</a>
                                            <span class="meta-separator">-</span>
                                            <a id="coEmailHtml" runat="server" href=""></a>
                                        </div>
                                    </div>
                                    
                                    <div id="coBioHtml" runat="server" class="entry-content">
                        ...
                        <div class="col-xl-3 col-lg-4 order-lg-1">
                            <div class="sidebar-inner">
                                ...
                                <div class="widget blog-widget widget-recent-posts mb--40">
                                    <h3 class="widget-title mb--25">Services</h3>
                                    <div id="servicesHtml" runat="server" class="recent-post">
                                ...
                                <div class="widget blog-widget widget-recent-posts mb--40">
                                    <h3 class="widget-title mb--25">Products</h3>
                                    <div id="productsHtml" runat="server" class="recent-post">
                                        <div class="recent-post__item">
                                            <div class="recent-post__thumb">
                                                <a href="single-post.html">
                                                    <img src="assets/img/blog/blog-1-70x70.jpg" alt="Blog">
