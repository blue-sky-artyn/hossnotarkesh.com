...
public partial class product_category : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            idServiceHtml.InnerText = "";// mainId.ToString();
            serviceNameHtml.InnerText = servicesTbl[0].ServiceTitle;
        }
        else
        {
            idServiceHtml.InnerText = "";//"All";
            serviceNameHtml.InnerText = "All services";
        }
        ...
        if (servicesTbl.Count > 0)
        {
            for (int i = servicesTbl.Count - 1; i >= 0; i--)
            {
                ...
                serviceImgHtml.Src = servicesTbl[0].coverPic;

                serviceTitleHtml.InnerText = servicesTbl[0].ServiceTitle;
                serviceDetailHtml.InnerHtml = servicesTbl[0].ServiceDetail;
